!(function (e) {
  e.fn.aceResponsiveMenu = function (s) {
    ...
    function o() {
      if (e(window).innerWidth() <= l)
        t.find("li.menu-active").removeClass("menu-active"),
          t.find("ul.slide").removeClass("slide").removeAttr("style"),
          t.addClass("collapse hide-menu"),
          t.attr("data-menu-style", ""),
          e(".menu-toggle").show();
      else {
        if (
          (t.attr("data-menu-style", d),
          t.removeClass("collapse hide-menu").removeAttr("style"),
          e(".menu-toggle").hide(),
          "accordion" == t.attr("data-menu-style"))
        )
          return void t.addClass("collapse");
        t.find("li.menu-active").removeClass("menu-active"),
          t.find("ul.slide").removeClass("slide").removeAttr("style");
      }
    }
    return (
      t.find("ul").addClass("sub-menu"),
      t.find("ul").siblings("a").append('<span class="arrow "></span>'),
      "accordion" == d && e(this).addClass("collapse"),
      e(window).innerWidth() <= l && o(),
        ...
        t.on("mouseover", "> li a", function () {
          ...
          t.on("click", "> li a", function () {
            if (
              ...
              e(this).parent().hasClass("menu-active"))
            )
              e(this)
                .parent()
                .children(".sub-menu")
