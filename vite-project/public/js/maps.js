  ...
  function mainMap() {
    ...
    function locationData(
      ...
      return (
        ...
        '<ul class="info d-block mb-0">' +
        '<li><span class="fas fa-star fz10 review-color"></span>' +
        locationPhone +
        "</li>" +
        "</ul>" +
        '<hr class="opacity-100">' +
        '<ul class="p-0 d-flex align-items-center justify-content-between mb-0">' +
        '<li class="listing-style1 p-0 m-0"><img class="rounded-circle" src="images/team/fl-s-1.png" alt=""><span class="online-badge"></span></li>' +
        '<li><p class="m-0 fz14">Starting at <span class="fw500 dark-color">$983</span></p></li>' +
        "</ul>" +
        "</div>" +
        "</div>" +
        '<div class="bottom-box">' +
        '<div class="places"><div class="place ' +
        locationColor +
        '"><span class="icon ' +
        locationIcon +
        '" ></span> ' +
    ...
    var locations = [
      [
        locationData(
          "images/resource/listing/1-1.jpg",
          "5",
          "7",
          "listing-single.html",
        ...
        -74.16938781738281,
        1,
        '<i class="icon flaticon-desk-bell"></i>',
      ],
      [
        locationData(
          "images/resource/listing/1-2.jpg",
          "5",
          "8",
          "listing-single.html",
      ...
      [
        locationData(
          "images/resource/listing/1-3.jpg",
          "5",
          "9",
          "listing-single.html",
        ...
        -73.11445617675781,
        3,
        '<i class="icon flaticon-tent"></i>',
      ],
      [
        locationData(
          "images/resource/listing/2-1.jpg",
          "5",
          "6",
          "listing-single.html",
          "I will do mobile app development for ios and android",
      ...
      [
        locationData(
          "images/resource/listing/2-2.jpg",
          "5",
          "5",
          "listing-single.html",
          "I will create modern flat design illustration",
      ...
      [
        locationData(
          "images/resource/listing/2-3.jpg",
          "5",
          "4",
          "listing-single.html",
          "I will do mobile app development for ios and android",
      ...
      [
        locationData(
          "images/resource/listing/2-4.jpg",
          "5",
          "3",
          "listing-single.html",
          "I will create modern flat design illustration ",
        ...
        -73.519478,
        7,
        '<i class="icon flaticon-mirror"></i>',
      ],
    ];
